  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<AppRole>(
      ...
      builder: (ctx, snap) {
        ...
        final isStaff = role == AppRole.owner || role == AppRole.admin || role == AppRole.support;
        ...
        return Scaffold(
          ...
          body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (ctx, s) {
              ...
              if (docs.isEmpty) {
                return Center(child: Text(isStaff ? 'لا توجد عناصر قيد الانتظار' : 'لا توجد طلبات بانتظارك'));
              }
